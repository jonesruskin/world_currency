...
public class MainActivity extends Activity {
    ...
    String[] currencyNames = {"INR", "USD", "EUR", "GBP", "SGD"};

    String[] currencyDescriptions = {"Ind Rupee", "US Dollar", "EU Euro", "UK Pounds", "Singapore Dollar"};

    int images[] = {R.drawable.ind, R.drawable.usd, R.drawable.eur,
            R.drawable.gbp, R.drawable.sing};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                amount1 = amount1 + 1;
                EditText plus = (EditText) findViewById(R.id.amount);
                plus.setText(String.valueOf(amount1));
